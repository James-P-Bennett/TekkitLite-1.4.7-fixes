...
class PlayerEventHandler implements Listener {
    ...
    // New event listener for EE3 WorldTransmutationEvent
    @EventHandler
    public void onWorldTransmutationEvent(WorldTransmutationEvent event) {
        ...
        // Check if the player is not in a trusted claim or in the wilderness
        if (claim == null || !claim.allowAccess(player).isEmpty()) {
            GriefPrevention.sendMessage(player, TextMode.Err, Messages.MiniumTransmutation);
