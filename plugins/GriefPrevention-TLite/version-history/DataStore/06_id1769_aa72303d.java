...
public abstract class DataStore 
{
	...
	private void loadMessages() 
	{
		...
		this.addDefault(defaults, Messages.WrathIgniters, "You don't have access to this ME Storage Monitor.", null);
		this.addDefault(defaults, Messages.WrathIgnitersBorder, "You don't have access to this ME Storage Monitor.", null);
		this.addDefault(defaults, Messages.Entropy, "You don't have access to this ME Storage Monitor.", null);
		this.addDefault(defaults, Messages.NoMeAccess, "You don't have access to this ME Storage Monitor.", null);
