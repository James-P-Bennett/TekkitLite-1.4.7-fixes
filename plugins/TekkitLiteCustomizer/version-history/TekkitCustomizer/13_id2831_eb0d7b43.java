...
public class TekkitCustomizer extends JavaPlugin
{
	...
	private void loadConfiguration()
	{
		...
		Map<String, List<String>> adjacentBannedConfig = config.getMapList("TekkitCustomizer.Bans.AdjacentBanned");
		for (Map.Entry<String, List<String>> entry : adjacentBannedConfig.entrySet()) {
			String groupName = entry.getKey();
			List<String> materialStrings = entry.getValue();
